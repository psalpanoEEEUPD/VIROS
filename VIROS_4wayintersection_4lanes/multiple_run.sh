...
do
	...
	do
		...
		do
			...
			mv "v${g}_p${h}_y${j}_s${i}_edge_data.xml" /home/veins/Desktop/VIROS_4way_car_4lanes/data/
			mv "v${g}_p${h}_y${j}_s${i}_lane_data.xml" /home/veins/Desktop/VIROS_4way_car_4lanes/data/
			mv "v${g}_p${h}_y${j}_s${i}_summary_data.xml" /home/veins/Desktop/VIROS_4way_car_4lanes/data/
			mv "v${g}_p${h}_y${j}_s${i}_stoplight_data.xml" /home/veins/Desktop/VIROS_4way_car_4lanes/data/
			mv "v${g}_p${h}_y${j}_s${i}_stoplight_data.csv" /home/veins/Desktop/VIROS_4way_car_4lanes/data/
			sleep 1
		done
		let i--
